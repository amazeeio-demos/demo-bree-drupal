...
1. Checkout this project repo and confirm the path is in Docker's file sharing config - https://docs.docker.com/docker-for-mac/#file-sharing
    ...
    ```bash
    git clone https://github.com/lagoon-examples/demo-bree-drupal.git demo-bree-drupal && cd $_
    ```
...
4. Visit the new site @ `http://demo-bree-drupal.docker.amazee.io`
...
6. Visit the new site @ `http://demo-bree-drupal.lndo.site`
